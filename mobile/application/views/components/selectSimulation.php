	...
	?>
				...
				<div class="row no-gutters">
					<div class="col-md-4">
						<img src="<?php echo base_url('../images/');
											echo ($gameResultRow->Game_Image) ? $gameResultRow->Game_Image : 'Game2.jpg'; ?>" class="card-img" alt="...">
					</div>
					<div class="col-md-8">
						<div class="card-body">
								...
								<?php if (time() > strtotime($gameResultRow->UG_GameStartDate) && time() < strtotime($gameResultRow->UG_GameEndDate)) { ?>
									...
									<?php if ($gameResultRow->US_LinkID == 1) { ?>
										...
										<?php if ($gameResultRow->UG_ReplayCount > 0 || $gameResultRow->UG_ReplayCount < 0 || $this->session->userdata('botUserData')->User_companyid == 21) { ?>
											...
											<a href="javascript:void(0);" class="replaySimulation" data-imageurl="<?php echo base_url('../images/');
																																														echo ($gameResultRow->Game_Image) ? $gameResultRow->Game_Image : 'Game2.jpg'; ?>" data-gameid="<?php echo $gameResultRow->Game_ID; ?>" data-toggle="tooltip" title="Replay"><img src="<?php echo base_url('../images/replay1.png'); ?>" alt="Replay" width="80" height="80"></a>
									...
									<?php } else { ?>
										...
										<?php } else { ?>
											...
											<a href="<?php echo base_url('PlaySimulation/input/' . base64_encode($gameResultRow->Game_ID)); ?>" data-toggle="tooltip" title="Play"><img src="<?php echo base_url('../images/play1.png'); ?>" alt="Play" width="80" height="80"></a>
										<?php } ?>
									...
									<small class="text-muted notAllowedToPlay" data-imageurl="<?php echo base_url('../images/');
																																						echo ($gameResultRow->Game_Image) ? $gameResultRow->Game_Image : 'Game2.jpg'; ?>" data-startdate="<?php echo date('d-m-Y', strtotime($gameResultRow->UG_GameStartDate)); ?>" data-enddate="<?php echo date('d-m-Y', strtotime($gameResultRow->UG_GameEndDate)); ?>" data-gamename="<?php echo $gameResultRow->Game_Name; ?>"><img src="<?php echo base_url('../images/timer.gif'); ?>" alt="Play " width="80" height="80" style="cursor: pointer;"></small>
								<?php } ?>
		...
		<script>
			...
			Swal.fire({
				...
				icon: 'error',
				title: 'No Mobile Simulation Assigned!',
