...
<section style="margin-top: 48px!important;">
  <div class="container" style="min-height:100vh;">
    ...
    <div class="tab-content row col-md-12 m-1" id="myTabContent" <?php echo ($findScenario->Scen_Image) ? "style='width:100%; min-height:100vh; background-image:url(" . base_url('../images/' . $findScenario->Scen_Image) . "); background-size: cover;background-position: center; background-repeat: no-repeat;'" : "style:width:100%; min-height:100vh;" ?>>
        ...
        ?>
          <div class="row clearfix <?php echo $ComponentLength . ' ' . $hideByAdmin; ?> componentDiv" id="removeCompDiv" <?php echo ($fontStyle) ? $fontStyle : "style='width:auto;'"; ?>>
            ...
            <div class="row <?php echo $CompDetailsChart; ?> ckEditorDiv" id="">
              ...
              <?php } else {
                echo $findLinkageSubRow->SubLink_Details;
              } ?>
            </div>
            ...
            <?php if ($findLinkageSubRow->SubLink_InputMode != 'none') { ?>
              <div class="row <?php echo $CompInputFields; ?> inputFieldDiv" id="">
                ...
                if ($findLinkageSubRow->SubLink_InputMode == 'carry') { ?>
                  ...
                  <input type="text" data-sublinkid="<?php echo $findLinkageSubRow->SubLink_ID; ?>" id="carry_<?php echo $findLinkageSubRow->SubLink_ID; ?>" value="<?php echo $findLinkageSubRow->input_current; ?>" readonly>
                <?php } elseif ($findLinkageSubRow->SubLink_InputMode == 'admin') {
                ...
                ?>
                  <!-- as now we have set the admin and carryForward value (updateAdminAndCarryFowardValues()) to db so no need for this condition(if or switch) we can directly put values from input table -->
                ...
                <?php } elseif ($findLinkageSubRow->SubLink_InputMode == 'formula') { ?>
...
<script>
  $(document).ready(function() {
    console.log("ScenNameIs: <?php echo $findScenario->Scen_Name; ?>");
