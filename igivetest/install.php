...
$_SESSION['INSTALL']['db_db'] = 'igivetest';
$_SESSION['INSTALL']['table_prefix'] = '';
$_SESSION['INSTALL']['title_postfix'] = 'iGiveTest';
...
writeInstallDialogRow($lngstr['install']['license_key'], getInputElement('key', @$_SESSION['INSTALL']['key']));
