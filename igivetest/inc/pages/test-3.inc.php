...
if(!$i_isallowed)
 ...
 $i_nAttemptsUsed = getTestAttemptsUsed($testid, $G_SESSION['userid']);
if($i_isallowed && ($i_rSet1->fields['test_attempts'] > 0))
 $i_isallowed = ($i_nAttemptsUsed < $i_rSet1->fields['test_attempts']);
if($i_isallowed) {  
