...
$lngstr['branding']['btm_sign'] = 'Copyright &copy; 2004-2012 Iglearn, Sight2k.<br />Todos los derechos reservados.';
// Sign in page:
...
$lngstr['calendar_day'] = 'Día';
$lngstr['calendar_year'] = 'Año';
$lngstr['calendar_hour'] = 'Hora';
$lngstr['calendar_minute'] = 'Minuto';
$lngstr['time_days'] = 'Días';
$lngstr['time_days_short'] = 'días';
...
$lngstr['label']['print_version'] = 'Ver versión de impresión';
...
$lngstr['button_next_page'] = 'Ir a la siguiente página';
$lngstr['button_prev_page'] = 'Ir a la página anterior';
$lngstr['button_first_page'] = 'Ir a la primera página';
$lngstr['button_last_page'] = 'Ir a la última página';

$lngstr['label']['view_edit_user'] = 'Ver/editar el perfil de usuario';

$lngstr['label_atype_multiple_choice'] = 'Opción múltiple';
$lngstr['label_atype_multiple_answer'] = 'Respuestas múltiples';
...
$lngstr['label_atype_essay'] = 'Composición';
...
$lngstr['page_title_lostpassword'] = '¿Olvidó su contraseña?';
...
$lngstr['page_reportsratings']['title'] = 'Clasificación';
$lngstr['page_reportsratings']['header'] = $lngstr['page_reportsratings']['title'];
$lngstr['page_statistics']['title'] = 'Estadísticas';
...
$lngstr['page_header_edittests'] = $lngstr['page_title_edittests'];
 ...
 $lngstr['page_testmanager_stats']['title'] = 'Estadísticas de examen';
...
$lngstr['page_header_questionbank'] = $lngstr['page_title_questionbank'];
 $lngstr['page_title_question_stats'] = 'Estadísticas de preguntas';
...
$lngstr['page_header_manageusers'] = $lngstr['page_title_manageusers'];
 ...
 $lngstr['page_title_users_settings'] = 'Configuración de usuario';
...
$lngstr['page_header_managegroups'] = $lngstr['page_title_managegroups'];
 $lngstr['page_title_groups_settings'] = 'Configuración de grupos';
...
$lngstr['page_header_subjects'] = $lngstr['page_title_subjects'];
 $lngstr['page_title_subjects_settings'] = 'Configuración de asignaturas';
...
$lngstr['page_title_grades'] = 'Sistemas de calificación';
$lngstr['page_header_grades'] = $lngstr['page_title_grades'];
 $lngstr['page_title_grades_edit'] = 'Configuración de sistema de calificación';
 $lngstr['page_header_grades_edit'] = $lngstr['page_title_grades_edit'];
$lngstr['page_title_gradescales'] = 'Escala de calificación';
$lngstr['page_header_gradescales'] = $lngstr['page_title_gradescales'];
 $lngstr['page_title_grade_settings'] = 'Editar calificación';
 $lngstr['page_header_grade_settings'] = $lngstr['page_title_grade_settings'];
$lngstr['page_title_config'] = 'Configuración';
$lngstr['page_header_config'] = $lngstr['page_title_config'];
$lngstr['page_title_visitors'] = 'Estadísticas web';
...
$lngstr['page_resourcemanager']['header'] = $lngstr['page_resourcemanager']['title'];
 $lngstr['page_resourcemanager_settings']['title'] = 'Configuración de recursos';
...
$lngstr['page_couponmanager']['header'] = $lngstr['page_couponmanager']['title'];
 $lngstr['page_couponmanager_settings']['title'] = 'Configuración de cupón';
...
$lngstr['label_mark_correct_fillintheblank'] = 'Escriba la respuesta correcta aquí.';

// Report Manager:
$lngstr['label_hdr_action'] = 'Acción';
...
// Test Manager:
$lngstr['label_action_test_settings'] = 'Configuración de exámenes';
$lngstr['label_action_questions_edit'] = 'Editar preguntas';
$lngstr['label_action_test_delete'] = 'Eliminar este examen';
$lngstr['label_action_tests_delete'] = 'Eliminar exámenes (seleccionados)';
...
$lngstr['label_action_question_append'] = 'Añadir esta pregunta al examen';
$lngstr['label_action_questions_append'] = 'Añadir preguntas al examen (seleccionadas)';
...
$lngstr['label_action_question_stats'] = 'Mostrar estadísticas';
$lngstr['label_action_questions_stats'] = 'Mostrar estadísticas (para entradas seleccionadas)';
$lngstr['label_action_manageusers_edit'] = 'Configuración de usuarios';
...
$lngstr['label_action_group_edit'] = 'Configuración de grupo';
$lngstr['label_action_test_groups_select'] = 'Asignar a grupos';
$lngstr['label_action_subject_edit'] = 'Configuración de asignaturas';
...
$lngstr['label_action_create_and_add_question'] = 'Crear/añadir pregunta al examen';
...
$lngstr['label_action_grade_settings'] = 'Configuración de sistemas de calificación';
$lngstr['label_action_grade_delete'] = 'Eliminar este sistema de calificación';
$lngstr['label_action_grades_delete'] = 'Eliminar sistemas de calificación (seleccionados)';
$lngstr['label_action_gradescales_edit'] = 'Editar la escala de calificación';
$lngstr['label_action_gradescales_delete'] = 'Eliminar calificaciones (seleccionadas)';
$lngstr['label_action_gradescale_edit'] = 'Editar esta calificación';
$lngstr['label_action_gradescale_delete'] = 'Eliminar esta calificación';
...
$lngstr['page-sections']['action_section_create'] = 'Crear una nueva sección';
$lngstr['page-sections']['action_section_edit'] = 'Editar esta sección';
$lngstr['page-sections']['action_section_delete'] = 'Eliminar esta sección';
...
$lngstr['label_result_got_grade'] = '<b>Calificación:</b> %s';
$lngstr['label_result_got_gradefeedback'] = '<b>Comentarios para la calificación:</b> %s';
$lngstr['label_result_do_not_show'] = 'Su examen ha sido calificado y grabado.';
$lngstr['label_result_showpdf'] = 'Haga clic aquí para generar el informe en PDF';
$lngstr['page_test']['result']['showhtml'] = 'Haga clic aquí para generar un informe HTML';

$lngstr['page_test_instructions']['next_page'] = 'Siguiente página';
...
$lngstr['page_reportsmanager']['hdr_test_attempts'] = 'Nº de intentos';
$lngstr['page_reportsmanager']['hdr_test_attempts_hint'] = 'Número de intentos excedido';
...
$lngstr['label_report_hdr_result_score'] = 'Puntuación';
$lngstr['label_report_hdr_result_score_hint'] = 'Puntuación (haga clic para ordenar por...)';
$lngstr['label_report_hdr_gscale_gradeid'] = 'Calificación';
$lngstr['label_report_hdr_gscale_gradeid_hint'] = 'Calificación (haga clic para ordenar por...)';
...
$lngstr['label_report_hdr2_test_questionid'] = 'Nº';
$lngstr['label_report_hdr2_test_questionid_hint'] = 'Número de pregunta (haga clic para ordenar por...)';
...
$lngstr['label_manageusers_hdr_user_email_hint'] = 'Correo electrónico (haga clic para ordenar por...)';
...
$lngstr['label_managegroups_hdr_group_description'] = 'Descripción';
$lngstr['label_managegroups_hdr_group_description_hint'] = 'Descripción de grupo (haga clic para ordenar por...)';
...
$lngstr['label_subjects_hdr_subject_description'] = 'Descripción';
$lngstr['label_subjects_hdr_subject_description_hint'] = 'Descripción de asignatura (haga clic para ordenar por...)';
...
$lngstr['label_etemplates_hdr_etemplate_description'] = 'Descripción';
$lngstr['label_etemplates_hdr_etemplate_description_hint'] = 'Descripción de plantilla de correo (haga clic para ordenar por...)';
...
$lngstr['page-rtemplates']['hdr_rtemplate_description'] = 'Descripción';
$lngstr['page-rtemplates']['hdr_rtemplate_description_hint'] = 'Descripción de plantilla de informe (haga clic para ordenar por...)';

$lngstr['label_grades_hdr_gscaleid'] = 'ID';
$lngstr['label_grades_hdr_gscaleid_hint'] = 'ID de sistema de calificación (haga clic para ordenar por...)';
$lngstr['label_grades_hdr_gscale_name'] = 'Nombre';
$lngstr['label_grades_hdr_gscale_name_hint'] = 'Nombre de sistema de calificación (haga clic para ordenar por...)';
$lngstr['label_grades_hdr_gscale_description'] = 'Descripción';
$lngstr['label_grades_hdr_gscale_description_hint'] = 'Descripción de sistema de calificación (haga clic para ordenar por...)';
$lngstr['label_gradescales_hdr_gscale_gradeid'] = 'ID';
$lngstr['label_gradescales_hdr_gscale_gradeid_hint'] = 'ID de calificación (haga clic para ordenar por...)';
$lngstr['label_gradescales_hdr_grade_from'] = 'Mín';
$lngstr['label_gradescales_hdr_grade_from_hint'] = 'Mínimo (haga clic para ordenar por...)';
$lngstr['label_gradescales_hdr_grade_to'] = 'Máx';
$lngstr['label_gradescales_hdr_grade_to_hint'] = 'Máximo (haga clic para ordenar por...)';
$lngstr['label_gradescales_hdr_grade_name'] = 'Nombre';
$lngstr['label_gradescales_hdr_grade_name_hint'] = 'Nombre de calificación (haga clic para ordenar por...)';
$lngstr['label_gradescales_hdr_grade_description'] = 'Descripción';
$lngstr['label_gradescales_hdr_grade_description_hint'] = 'Descripción de calificación (haga clic para ordenar por...)';
...
$lngstr['label_visitors_hdr_ip'] = 'Dirección IP';
$lngstr['label_visitors_hdr_ip_hint'] = 'Dirección IP';
...
$lngstr['page-sections']['hdr_section_name_hint'] = 'Nombre de sección (haga clic para ordenar por...)';
$lngstr['page-sections']['hdr_section_description'] = 'Descripción';
$lngstr['page-sections']['hdr_section_description_hint'] = 'Descripción de sección (haga clic para ordenar por...)';
...
$lngstr['label_password'] = 'Contraseña:';
$lngstr['label_confirmpassword'] = 'Confirmar contraseña:';
$lngstr['label_newpassword'] = 'Nueva contraseña:';
$lngstr['label_email'] = 'Correo:';
$lngstr['label_title'] = 'Título:';
$lngstr['label_firstname'] = 'Nombre:';
$lngstr['label_lastname'] = 'Apellidos:';
$lngstr['label_middlename'] = 'Segundo nombre:';

$lngstr['label_address'] = 'Dirección:';
$lngstr['label_city'] = 'Ciudad:';
$lngstr['label_state'] = 'Estado/provincia:';
$lngstr['label_zip'] = 'Código postal:';
$lngstr['label_country'] = 'País:';
$lngstr['label_phone'] = 'Teléfono:';
$lngstr['label_fax'] = 'Fax:';
$lngstr['label_mobile'] = 'Móvil:';
$lngstr['label_pager'] = 'Buscapersonas:';
$lngstr['label_ipphone'] = 'Teléfono IP:';
$lngstr['label_webpage'] = 'Página web:';
...
$lngstr['label_birthday'] = 'Cumpleaños:';
...
$lngstr['label_userfield_type_items'] = array(CONFIG_CONST_type_singlelinetext => 'Texto de una sola línea', CONFIG_CONST_type_multilinetext => 'Texto de múltiples líneas', CONFIG_CONST_type_dropdownlist => 'Lista desplegable');
...
$lngstr['page_reportsmanager']['filter_dates_years_items'] = array(0 => '', 'y1' => 'Mostrar 1 año', 'y2' => 'Mostrar 2 años', 'y3' => 'Mostrar 3 años', 'y4' => 'Mostrar 4 años', 'y5' => 'Mostrar 5 años', 'y6' => 'Mostrar 6 años'); // 0 => 'Mostrar todo'
...
$lngstr['page_register']['no_email'] = 'Correo electrónico incorrecto.<br>';
$lngstr['page_register']['no_password'] = 'Las contraseñas no coinciden.<br>';
$lngstr['page_register']['no_title'] = 'Título incorrecto.<br>';
...
$lngstr['page_register']['no_address'] = 'Dirección incorrecta.<br>';
$lngstr['page_register']['no_city'] = 'Ciudad incorrecta.<br>';
$lngstr['page_register']['no_state'] = 'Estado/Provincia incorrecto.<br>';
$lngstr['page_register']['no_zip'] = 'Código postal incorrecto.<br>';
$lngstr['page_register']['no_country'] = 'País incorrecto.<br>';
$lngstr['page_register']['no_phone'] = 'Teléfono incorrecto.<br>';
$lngstr['page_register']['no_fax'] = 'Fax incorrecto.<br>';
$lngstr['page_register']['no_mobile'] = 'Móvil incorrecto.<br>';
$lngstr['page_register']['no_pager'] = 'Buscapersonas incorrecto.<br>';
$lngstr['page_register']['no_ipphone'] = 'Teléfono IP incorrecto.<br>';
$lngstr['page_register']['no_webpage'] = 'Página web incorrecta.<br>';
...
$lngstr['page_register']['no_birthday'] = 'Cumpleaños incorrecto.<br>';
...
$lngstr['page_register']['no_caddress'] = 'Dirección de la empresa incorrecta.<br>';
...
$lngstr['page_register']['no_czip'] = 'Código postal de la empresa incorrecto.<br>';
$lngstr['page_register']['no_ccountry'] = 'País de la empresa incorrecto.<br>';
$lngstr['page_register']['no_cphone'] = 'Teléfono de la empresa incorrecto.<br>';
$lngstr['page_register']['no_cfax'] = 'Fax de la empresa incorrecto.<br>';
$lngstr['page_register']['no_cmobile'] = 'Móvil de la empresa incorrecto.<br>';
$lngstr['page_register']['no_cpager'] = 'Buscapersonas de la empresa incorrecto.<br>';
$lngstr['page_register']['no_cipphone'] = 'Teléfono IP de la empresa incorrecto.<br>';
$lngstr['page_register']['no_cwebpage'] = 'Página web de la empresa incorrecta.<br>';
...
$lngstr['err_signin_incorrect'] = 'No se pudo iniciar sesión, nombre de usuario o contraseña incorrecta.<br>';

// Register page:
$lngstr['page-register']['intro'] = 'Usted puede usar esta forma para añadir un usuario.';
$lngstr['page-register']['successful'] = 'El usuario "%s" fue añadido.';
$lngstr['page-register']['check_activation_email'] = 'Hemos enviado un correo a su dirección, siga las instrucciones para continuar con el registro.';
...
$lngstr['page-register']['title_items'] = array('' => $lngstr['label_none'], 'Dr.' => 'Dr.', 'Señorita' => 'Señorita', 'Sr.' => 'Sr.', 'Sra.' => 'Sra.', 'Srita..' => 'Srita.', 'Prof.' => 'Prof.', 'Rev.' => 'Rev.');
$lngstr['page_register']['required_mark'] = REQUIRED_FIELD_MARK.' = Campo obligatorio';

// Sign in page:
$lngstr['page_signin_box_signin_intro'] = '<b>Por favor, inicie sesión</b>';
$lngstr['page_signin_box_signin'] = $lngstr['label_username'];
$lngstr['page_signin_box_password'] = $lngstr['label_password'];
$lngstr['page_signin_box_register_intro'] = '<b>¿No tiene cuenta?</b> Puede registrarse al hacer <a href="register.php">clic aquí</a>.';
$lngstr['page_signin_box_lostpassword_intro'] = '<b>¿Olvidó su contraseña?</b> Si olvidó <a href="lostpassword.php">su contraseña</a>, le podemos enviar una nueva por correo electrónico.';
$lngstr['page_signin']['test_code'] = 'Código de examen:';

// Forgot password page:
$lngstr['page_lostpassword_enter_username'] = '<b>Introduzca su nombre de usuario</b>';
$lngstr['button_send_new_password'] = 'Enviar una nueva contraseña';
$lngstr['err_username_not_found'] = 'Nombre de usuario no encontrado. Vuelva a intentar.';
$lngstr['inf_password_reset'] = 'Su contraseña ha sido actualizada. Por favor, compruebe su correo electrónico.';
...
$lngstr['page_panel_hdr_test_hint'] = 'Nombre y descripción del examen';
...
$lngstr['page_panel_status_will_be_available_on'] = 'Estará disponible<br>%s';
...
$lngstr['page_test_results_homepage'] = 'Volver a la página de hacer examen';
...
$lngstr['page_test']['qst_finish_test'] = '¿Está seguro de que desea terminar este examen?';
...
$lngstr['page_grades_delete_grade'] = 'Eliminar un sistema de calificación';
$lngstr['page_gradescales_delete_grade'] = 'Eliminar una calificación';
...
$lngstr['page_testmanager']['test_code'] = 'Código de examen:';
$lngstr['page_edittests_testenabled'] = 'Este examen está activo';
...
$lngstr['page_testmanager']['content_protection'] = 'Protección de contenido:';
...
$lngstr['page_testmanager']['review_options'] = 'Opciones de revisión:';
$lngstr['page_testmanager']['review_list'] = array(0 => 'Prohibir cualquier revisión', 1 => 'Permitir revisar preguntas');
$lngstr['page_edittests_gradingsystem'] = 'Sistema de calificación:';
...
$lngstr['page_edittests_result_showgrade'] = 'Mostrar calificación';
$lngstr['page_testmanager']['result_showgradefeedback'] = 'Mostrar comentarios para la calificación';
...
$lngstr['page_edittests_testdescription'] = 'Descripción corta:';
...
$lngstr['page_edittests_assignto_everybody'] = 'Asignar a todos (sobrepasa cualquier configuración)';
...
$lngstr['page-testsettings']['report_grade_condition'] = 'Condición de calificación:';
$lngstr['page-testsettings']['no_condition'] = 'Sin condición';
...
$lngstr['page_edittests_sendresultsbyemail'] = 'Enviar resultados por correo electrónico a:';
...
$lngstr['page_testmanager']['view_test_stats'] = 'Ver estadísticas de examen';
...
$lngstr['page_importtest_ut_import_document_hint'] = 'Pegue el documento de sistema UniTest aquí';
$lngstr['page_importtest_ut_import_document_howto'] = '1. Ejecute el editor de UniTest;<br>2. Seleccione el menú Import Document from the File (Importar documento del archivo) -> Export (Exportar);<br>3. Copie el texto usando el portapapeles y péguelo aquí.';
...
$lngstr['page_testmanager_import']['answer_delimiter'] = 'Prefijo de opción:';
$lngstr['page_testmanager_import']['answer2_delimiter'] = 'Prefijo de opción (2ª columna):';
$lngstr['page_testmanager_import']['preq_delimiter'] = 'Prefijo de instrucciones de pregunta:';
$lngstr['page_testmanager_import']['postq_delimiter'] = 'Prefijo de explicación de pregunta:';
...
$lngstr['page_testmanager_stats']['all_participants'] = 'Estadísticas: todos los participantes';
...
$lngstr['page_testmanager_stats']['test_high_score'] = 'Calificación más alta:';
$lngstr['page_testmanager_stats']['test_average_score'] = 'Promedio de calificación:';
$lngstr['page_testmanager_stats']['test_low_score'] = 'Calificación más baja:';
$lngstr['page_testmanager_stats']['test_std_deviation'] = 'Desviación estándar:';
$lngstr['page_testmanager_stats']['test_variance'] = 'Variación:';
$lngstr['page_testmanager_stats']['hdr_grade_data'] = 'Datos de calificación';
$lngstr['page_testmanager_stats']['hdr_grade_data_hint'] = 'Datos de calificación';
...
$lngstr['page_testmanager_stats']['this_participant'] = 'Estadísticas: este participante';
...
$lngstr['page_testmanager_stats']['hdr_subject_questions'] = 'Tamaño';
$lngstr['page_testmanager_stats']['hdr_subject_questions_hint'] = 'Tamaño del muestreo';
...
$lngstr['page_testmanager_stats']['view_results_stats'] = 'Ver estadísticas';
...
$lngstr['page_subjects_subjectdescription'] = 'Descripción de la asignatura:';

// Grades page:
$lngstr['label_action_create_grade'] = 'Crear nuevo sistema de calificación';
$lngstr['label_action_create_gradescale'] = 'Crear nueva calificación';
$lngstr['page_grades_gscaleid'] = 'ID de sistema de calificación:';
$lngstr['page_grades_gradename'] = 'Nombre de sistema de calificación:';
$lngstr['page_grades_gradedescription'] = 'Descripción de sistema de calificación:';
$lngstr['page_grades_gradescale'] = 'Escala de calificación:';
$lngstr['page_grades_gradescale_text'] = 'Editar la escala';
$lngstr['page_grades']['edit_grade'] = 'editar esta calificación';
$lngstr['label_action_grade_moveup'] = 'Mover arriba';
$lngstr['label_action_grade_movedown'] = 'Mover abajo';
$lngstr['page_grade_gscaleid'] = 'ID de calificación:';
$lngstr['page_grade_gradename'] = 'Nombre de calificación:';
$lngstr['page_grade_gradedescription'] = 'Descripción de calificación:';
$lngstr['page_grade']['feedback'] = 'Comentarios de calificación:';
$lngstr['page_grade']['section_advanced'] = 'Avanzado (mostrar/ocultar)';
$lngstr['page_grade_gradefrom'] = 'Mínimo (%):';
$lngstr['page_grade_gradeto'] = 'Máximo (%):';
...
$lngstr['page_editquestion_answer_count'] = 'Número de respuestas:';
...
$lngstr['page_editquestion']['shuffle_answers_items'] = array(0 => 'Predeterminado (heredar)', 1 => 'Sin aleatorias', 2 => 'Aleatorias', 3 => 'Aleatorias (excepto la primera)', 4 => 'Aleatorias (excepto la última)');
...
$lngstr['page_editquestion_emptyquestion'] = '<p><strong>Por favor, introduzca su pregunta aquí...</strong></p>';
...
$lngstr['page_visitordetails_ipaddress'] = 'Dirección IP:';
$lngstr['page_visitordetails_host'] = 'Host:';
$lngstr['page_visitordetails_referer'] = 'Remitente:';
$lngstr['page_visitordetails_inurl'] = 'Página de entrada:';
$lngstr['page_visitordetails_outurl'] = 'Página de salida:';
...
$lngstr['page_config']['list_length'] = 'Tamaño de lista:';
$lngstr['page_config']['store_logs'] = 'Estadísticas web:';
...
$lngstr['page_config']['upon_registration_select'] = array(0 => 'Activar, no hacer nada', 1 => 'Activar e iniciar sesión automáticamente', 2 => 'No activar, enviar el correo para la activación', 3 => 'No activar, usar esquema personalizado (p.e. procesamiento de pago)');
$lngstr['page_config']['reg_intro'] = 'Introducción:';
...
$lngstr['page_users']['section_personal'] = 'Información personal (mostrar/ocultar)';
$lngstr['page_users']['section_work'] = 'Información de trabajo (mostrar/ocultar)';
$lngstr['page_users']['section_additional'] = 'Información adicional (mostrar/ocultar)';

$lngstr['page_users']['userenabled'] = 'Este usuario está activo';
$lngstr['page_users']['joindate'] = 'Fecha de inscripción:';
$lngstr['page_users']['logindate'] = 'Fecha de última sesión:';
...
$lngstr['page_managegroups_groupdescription'] = 'Descripción de grupo:';
$lngstr['page_groups_access_rights'] = 'Derechos de acceso:';
$lngstr['page_groups_access_tests'] = 'Exámenes:';
$lngstr['page_groups_access_tests_select'] = array(0 => "Acceso denegado", 1 => "Ver lista de exámenes", 2 => "Pasar examen");
$lngstr['page_groups_access_testmanager'] = 'Administrador de exámenes:';
$lngstr['page_groups_access_testmanager_select'] = array(0 => "Acceso denegado", 1 => "Leer", 2 => "Escribir");
$lngstr['page_groups_access_gradingsystems'] = 'Sistemas de calificación:';
...
$lngstr['page_groups_access_visitors'] = 'Estadísticas web:';
$lngstr['page_groups_access_visitors_select'] = $lngstr['page_groups_access_testmanager_select'];
$lngstr['page_groups_access_config'] = 'Configuración:';
...
$lngstr['page_etemplates_etemplatedescription'] = 'Descripción de plantilla:';
...
$lngstr['page-rtemplates']['rtemplatedescription'] = 'Descripción de plantilla:';
...
$lngstr['page_resourcemanager']['hdr_resource_description'] = 'Descripción';
$lngstr['page_resourcemanager']['hdr_resource_description_hint'] = 'Descripción de recurso (ordenar por)';
$lngstr['page_resourcemanager']['action_create_resource'] = 'Crear un nuevo recurso';
$lngstr['page_resourcemanager']['action_edit_resource'] = 'Configuración de recurso';
$lngstr['page_resourcemanager']['qst_delete_resource'] = '¿Está seguro de que desea eliminar este recurso?';
$lngstr['page_resourcemanager']['qst_delete_resources'] = '¿Está seguro de que desea eliminar los recursos seleccionados?';
...
$lngstr['page_resourcemanager_settings']['is_active'] = 'Este recurso está activo';
...
$lngstr['page_resourcemanager_settings']['resource_description'] = 'Descripción de recurso:';
...
$lngstr['page_resourcemanager_settings']['resource_url'] = 'Dirección URL de recurso:';
...
$lngstr['page_resources']['hdr_resource_hint'] = 'Descripción y nombre del recurso';
...
$lngstr['page_couponmanager']['hdr_couponid_hint'] = 'ID de cupón (haga clic para ordenar por)';
$lngstr['page_couponmanager']['hdr_coupon_name'] = 'Nombre de cupón';
$lngstr['page_couponmanager']['hdr_coupon_name_hint'] = 'Nombre de cupón (haga clic para ordenar por)';
$lngstr['page_couponmanager']['hdr_coupon_description'] = 'Descripción';
$lngstr['page_couponmanager']['hdr_coupon_description_hint'] = 'Descripción de cupón (haga clic para ordenar por)';
$lngstr['page_couponmanager']['hdr_coupon_code'] = 'Código';
$lngstr['page_couponmanager']['hdr_coupon_code_hint'] = 'Código de cupón (haga clic para ordenar por)';
...
$lngstr['page_couponmanager']['action_create_coupon'] = 'Crear un nuevo cupón';
$lngstr['page_couponmanager']['action_edit_coupon'] = 'Configuración de cupón';
$lngstr['page_couponmanager']['qst_delete_coupon'] = '¿Está seguro de que desea eliminar este cupón?';
$lngstr['page_couponmanager']['qst_delete_coupons'] = '¿Está seguro de que desea eliminar los cupones seleccionados?';
$lngstr['page_couponmanager']['action_delete_coupon'] = 'Eliminar este cupón';
$lngstr['page_couponmanager']['action_delete_coupons'] = 'Eliminar cupones (seleccionados)';
$lngstr['page_couponmanager']['delete_coupon'] = 'Eliminar un cupón';
$lngstr['inf_cant_access_couponmanager'] = 'No tiene derechos suficientes para acceder a los cupones.<br>';
$lngstr['page_couponmanager_settings']['is_active'] = 'Este cupón está activo';
$lngstr['page_couponmanager_settings']['couponid'] = 'ID de cupón:';
$lngstr['page_couponmanager_settings']['coupon_name'] = 'Nombre de cupón:';
$lngstr['page_couponmanager_settings']['coupon_description'] = 'Descripción de cupón:';
$lngstr['page_couponmanager_settings']['coupon_code'] = 'Código de cupón:';
$lngstr['page_couponmanager_settings']['coupon_value'] = 'Valor de cupón ('.  $lngstr['language']['currency_name'].'):';
...
$lngstr['page_buycheckout']['err_no_coupon'] = 'Por favor, verifique su código de cupón.<br>';
...
$lngstr['email_answer_points'] = 'Puntos: ';
...
$lngstr['err_no_questions_left_in_bank'] = 'El número de preguntas aleatorias es mayor al número de preguntas en esta asignatura.<br>';
$lngstr['err_no_tests'] = 'Actualmente no hay exámenes disponibles.<br>';
...
$lngstr['inf_cant_view_results'] = 'No tiene derechos suficientes para ver los resultados de exámenes.<br>';
$lngstr['inf_cant_view_reportsmanager_reportsratings'] = 'No tiene suficientes derechos para ver la página de clasificación.<br>';
$lngstr['inf_cant_view_this_test_details'] = 'No tiene derechos suficientes para ver los resultados de este examen.<br>';
$lngstr['inf_cant_edit_tests'] = 'No tiene derechos suficientes para editar los exámenes.<br>';
...
$lngstr['inf_cant_access_grades'] = 'No tiene derechos suficientes para acceder a los sistemas de calificación.<br>';
$lngstr['inf_cant_access_visitors'] = 'No tiene derechos suficientes para acceder a la sección de las estadísticas web.<br>';
$lngstr['inf_cant_access_config'] = 'No tiene derechos suficientes para acceder a la sección de la configuración.<br>';
...
$lngstr['err_no_answers_in_question'] = '<b><a href="question-bank.php?action=editq&questionid=%1$d">La pregunta con ID %1$d</a></b> no tiene respuestas, por favor, corríjala.<br>';
$lngstr['err_no_answer_given'] = 'Usted no respondió.<br>';
...
$lngstr['qst_delete_test'] = '¿Está seguro de que desea borrar este examen?';
$lngstr['qst_delete_tests'] = '¿Está seguro de que desea borrar los exámenes seleccionados?';
$lngstr['qst_delete_question'] = '¿Está seguro de que desea borrar esta pregunta?';
$lngstr['qst_delete_questions'] = '¿Está seguro de que desea borrar las preguntas seleccionadas?';
$lngstr['qst_delete_question_link'] = '¿Está seguro de que desea borrar esta pregunta del examen?';
$lngstr['qst_delete_question_links'] = '¿Está seguro de que desea borrar las preguntas seleccionadas del examen?';
$lngstr['qst_delete_record'] = '¿Está seguro de que desea borrar esta entrada?';
$lngstr['qst_delete_records'] = '¿Está seguro de que desea borrar las entradas seleccionadas?';
$lngstr['qst_delete_user'] = '¿Está seguro de que desea borrar este usuario?';
$lngstr['qst_delete_users'] = '¿Está seguro de que desea borrar los usuarios seleccionados?';
$lngstr['qst_delete_group'] = '¿Está seguro de que desea borrar este grupo?';
$lngstr['qst_delete_groups'] = '¿Está seguro de que desea borrar los grupos seleccionados?';
$lngstr['qst_delete_subject'] = '¿Está seguro de que desea borrar esta asignatura?';
$lngstr['qst_delete_subjects'] = '¿Está seguro de que desea borrar las asignaturas seleccionadas?';
$lngstr['qst_delete_etemplate'] = '¿Está seguro de que desea borrar esta plantilla de correo?';
$lngstr['qst_delete_etemplates'] = '¿Está seguro de que desea borrar las plantillas de correo seleccionadas?';
$lngstr['qst_delete_grade'] = '¿Está seguro de que desea borrar este sistema de calificación?';
$lngstr['qst_delete_grades'] = '¿Está seguro de que desea borrar los sistemas de calificación seleccionados?';
$lngstr['qst_delete_gradescale'] = '¿Está seguro de que desea borrar esta calificación?';
$lngstr['qst_delete_gradescales'] = '¿Está seguro de que desea borrar las calificaciones seleccionadas?';
$lngstr['qst_delete_visitor'] = $lngstr['qst_delete_record'];
$lngstr['qst_delete_visitors'] = $lngstr['qst_delete_records'];
$lngstr['page-sections']['qst_section_delete'] = '¿Está seguro de que desea borrar esta sección?';
$lngstr['page-sections']['qst_sections_delete'] = '¿Está seguro de que desea borrar las secciones seleccionadas?';
$lngstr['page-rtemplates']['qst_rtemplate_delete'] = '¿Está seguro de que desea borrar esta plantilla de informe?';
$lngstr['page-rtemplates']['qst_rtemplates_delete'] = '¿Está seguro de que desea borrar las plantillas de informe seleccionadas?';

// Install:
$lngstr['install_title'] = 'Instalar - iGiveTest';
$lngstr['install_page1'] = 'Paso 1 - Configuración de idioma';
$lngstr['install_page1_description'] = '<p><b>Idioma:</b> Por favor, seleccione un idioma.';
$lngstr['install_language'] = 'Idioma:';
$lngstr['install_page2'] = 'Paso 2 - Configuración general';
$lngstr['install_page2_description'] = '<p><b>Nombre de sitio web:</b> Especifique, por favor, el título del sitio web.
<p><b>Correo predeterminado:</b> Especifique la dirección predeterminada para el campo "Remitente" de correos electrónicos.
<p><b>License key:</b> Please specify your iGiveTest license key.
<p><b>URL de iGiveTest:</b> Especifique la dirección web en la que iGiveTest estará disponible.
<p><b>Directorio de iGiveTest:</b> Por favor, especifique la ruta completa para esta instalación
<p><b>URL de archivos de iGiveTest:</b> Por favor, especifique la dirección web en la que los archivos subidos estarán disponibles.
<p><b>Directorio de archivos de iGiveTest:</b> Especifique la ruta completa del directorio donde iGiveTest podrá guardar los archivos subidos. Los usuarios del servidor web deben tener suficientes derechos para leer y escribir en este directorio (normalmente "nadie" o "apache").';
$lngstr['install_titlepostfix'] = 'Título del sitio web:';
...
$lngstr['install_dirrootfull_doesnotexists'] = 'La configuración de "Directorio de iGiveTest" es incorrecta. El valor ha sido actualizado.<br>';
$lngstr['install_urlfiles'] = 'URL de archivos iGiveTest:';
$lngstr['install_dirfilesfull'] = 'Directorio de archivos de iGiveTest:';
$lngstr['install_page3'] = 'Paso 3 - Configuración de la base de datos';
$lngstr['install_page3_description'] = '<p>Configure la base de datos donde se almacenarán los datos de iGiveTest. Esta base de datos ya debe haber sido creada y usted debe contar con el nombre de usuario y contraseña.';
...
$lngstr['install_dbpassword'] = 'Contraseña:';
	$lngstr['install']['license_key'] = 'License key:';
$lngstr['install_dbdriver_cannotconnect'] = 'No se pudo establecer conexión con la base de datos, verifique su configuración.<br>';
$lngstr['install_cannotwritetoconfig'] = 'No se pudo escribir en inc/confic.inc.php';
$lngstr['install_downloadconfig'] = '<p>Por favor, guarde <b><a href="install.php?download=1" target=_blank>este archivo</a></b> con el nombre config.inc.php y póngalo en el directorio inc/.';
$lngstr['install_canwritetoconfig'] = '<p>El archivo config.inc ha sido creado.';
$lngstr['install_page4'] = 'Instalación terminada';
$lngstr['install_page4_description'] = '<p>Presione el botón "Siguiente" para configurar la base de datos de iGiveTest.';
...
$lngstr['install_phpversion'] = 'Versión PHP:';
...
Aquí están los resultados de su examen:
...
Calificación total: [RESULT_POINTS_SCORED] / [RESULT_POINTS_POSSIBLE] ([RESULT_PERCENTS]%)
Calificación: [RESULT_GRADE]

Saludos,
El equipo de iGiveTest';

$lngstr['initdb_etemplates_2_name'] = 'Registrar una cuenta (sin activación por correo)';
$lngstr['initdb_etemplates_2_description'] = 'Plantilla de correo para registro de usuario';
$lngstr['initdb_etemplates_2_subject'] = 'iGiveTest.com - Detalles de registro';
...
Usted puede iniciar sesión en el sistema al hacer clic en:
...
$lngstr['initdb_etemplates_3_name'] = 'Registrar una cuenta (activación por correo)';
$lngstr['initdb_etemplates_3_description'] = 'Plantilla de correo para registro de usuario';
$lngstr['initdb_etemplates_3_subject'] = 'iGiveTest.com - Activación de cuenta';
...
Le falta sólo un paso más:

Para terminar la activación de su cuenta, haga clic en el siguiente enlace:
...
$lngstr['initdb_etemplates_4_subject'] = 'iGiveTest.com - Cuenta activada';
$lngstr['initdb_etemplates_4_body'] = 'Estimado(-a) [USER_FIRST_NAME],

Su cuenta ha sido activada exitosamente

Puede iniciar sesión al hacer clic en:
...
$lngstr['initdb_etemplates_5_subject'] = 'iGiveTest.com - Detalles de registro de nuevo usuario';
...
$lngstr['initdb_etemplates_50_name'] = 'Recuperación de contraseña';
$lngstr['initdb_etemplates_50_description'] = 'Plantilla de recuperación de contraseña';
$lngstr['initdb_etemplates_50_subject'] = 'iGiveTest - Recuperación de contraseña';
$lngstr['initdb_etemplates_50_body'] = 'Estimado(-a) [USER_FIRST_NAME],

Le hemos establecido una contraseña nueva.
...
$lngstr['initdb_gscales_1_name'] = 'Sistema de calificación A-F(60% aprueba)';
$lngstr['initdb_gscales_2_name'] = 'Sistema de calificación aprobado/suspendido';
$lngstr['initdb_gscales_3_name'] = 'Sistema de calificación ECTS';
$lngstr['initdb_gscales_4_name'] = 'Sistema de calificación GPA';
$lngstr['initdb_gscales_5_name'] = 'Sistema de calificación de 6 notas (Alemania)';
$lngstr['initdb_gscales_6_name'] = 'Sistema de calificación de 5 notas (Europa Oriental)';
$lngstr['initdb_gscales_1_description'] = 'Sistema de calificación A-F';
$lngstr['initdb_gscales_2_description'] = 'Sistema de calificación aprobado/suspendido';
$lngstr['initdb_gscales_3_description'] = 'Sistema de calificación ECTS';
$lngstr['initdb_gscales_4_description'] = 'Sistema de calificación GPA';
$lngstr['initdb_gscales_5_description'] = 'Sistema de calificación de 6 notas (Alemania)';
$lngstr['initdb_gscales_6_description'] = 'Sistema de Calificación de 5 notas (Europa Oriental)';
...
$lngstr['initdb_gscales_3_3_description'] = 'Bien (buen trabajo pero con un número de errores importante)';
$lngstr['initdb_gscales_3_4_description'] = 'Satisfactorio (aceptable pero con errores importantes)';
$lngstr['initdb_gscales_3_5_description'] = 'Suficiente (el resultado cubre los mínimos criterios)';
$lngstr['initdb_gscales_3_6_description'] = 'Suspendido (Se requiere más esfuerzo para aprobar este examen)';
...
$lngstr['initdb_groups_19_description'] = 'Los usuarios no pueden hacer cambios por accidente ni con intención (grupo de sistema)';
...
$lngstr['initdb_rtemplates_1_name'] = 'Plantilla de informe nº 1';
$lngstr['initdb_rtemplates_1_description'] = 'Plantilla de informe nº 1';
...
<strong>Calificación:</strong> [RESULT_GRADE]</p>
<p><strong>Detalles:</strong><br>[RESULT_DETAILED_1]</p>';
$lngstr['initdb_subjects_1_name'] = '[Sin título]';
$lngstr['initdb_subjects_1_description'] = 'Sin descripción';
...
$lngstr['initdb_instructions'] = 'Por favor, utilice como nombre de usuario "<strong>admin</strong>" y contraseña "<strong>admin</strong>" para iniciar sesión.<br><strong>Recuerde:</strong> se recomienda cambiar su contraseña.';
...
$lngstr['tooltip_tests'] = '<p>Esta página está destinada para crear/editar exámenes.</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['label_action_create_test'].'"></td><td class=rowone width="100%" colspan=4>Para crear un examen, presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-gear.gif" title="'.$lngstr['label_action_test_settings'].'"></td><td class=rowone width="100%" colspan=4>Para cambiar la configuración del examen, presione este botón.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-groups.gif" title="'.$lngstr['label_action_test_groups_select'].'"></td><td class=rowone width="100%" colspan=4>Para asignar examen(es) a ciertos grupos de usuarios, presione el botón a la derecha del examen o seleccione todos los exámenes necesarios usando las casillas a la izquierda y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_questions_edit'].'"></td><td class=rowone width="100%" colspan=4>Para editar las preguntas del examen, presione el botón a la derecha del examen.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_test_delete'].'"></td><td class=rowone width="100%" colspan=4>Para eliminar examen(es), presione el botón a la derecha del examen o seleccione todos los exámenes necesarios usando las casillas a la izquierda y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Utilice estos botones para cambiar las páginas.</td></tr>
</table></p>';
$lngstr['tooltip_gscales'] = '<p>Esta página se usa para editar los sistemas de calificación.</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['label_action_create_grade'].'"></td><td class=rowone width="100%" colspan=4>Para crear un nuevo sistema de calificación presione este botón.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-gear.gif" title="'.$lngstr['label_action_grade_settings'].'"></td><td class=rowone width="100%" colspan=4>Para cambiar la configuración del sistema de calificación, presione el botón a la derecha del nombre.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_gradescales_edit'].'"></td><td class=rowone width="100%" colspan=4>Para editar los parámetros, presione el botón a la derecha del nombre.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_grade_delete'].'"></td><td class=rowone width="100%" colspan=4>Para eliminar sistema(s) de calificación, presione el botón a la derecha del sistema de calificación o seleccione todos los sistemas de calificación necesarios usando las casillas a la izquierda y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Utilice estos botones para cambiar las páginas.</td></tr>
</table></p>';
$lngstr['tooltip_gscales_grades'] = '<p>Esta página está destinada para crear/editar escalas de calificación.</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['label_action_create_gradescale'].'"></td><td class=rowone width="100%" colspan=4>Para crear una nueva calificación, presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_gradescale_edit'].'"></td><td class=rowone width="100%" colspan=4>Para editar una calificación, presione el botón a la derecha de la calificación.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=10 border=0 src="images/button-up.gif" title="'.$lngstr['label_action_grade_moveup'].'"><br><img width=20 height=10 border=0 src="images/button-down.gif" title="'.$lngstr['label_action_grade_movedown'].'"></td><td class=rowone width="100%" colspan=4>Para mover una calificación en la lista arriba o abajo, presione la parte superior o inferior del botón a la derecha de la calificación.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_gradescale_delete'].'"></td><td class=rowone width="100%" colspan=4>Para eliminar calificación, presione el botón a la derecha o seleccione los elementos usando la casilla de su izquierda y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Utilice estos botones para cambiar las páginas.</td></tr>
</table></p>';
$lngstr['tooltip_etemplates'] = '<p>Esta página está destinada para crear/editar plantillas de correo.</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['label_action_create_etemplate'].'"></td><td class=rowone width="100%" colspan=4>Para crear una nueva plantilla de correo, presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_etemplates_edit'].'"></td><td class=rowone width="100%" colspan=4>Para editar plantillas de correo, presione el botón a la derecha de la plantilla.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_etemplate_delete'].'"></td><td class=rowone width="100%" colspan=4>Para eliminar plantilla(s) de correo, presione el botón a la derecha de la plantilla de correo o seleccione todas las plantillas de correo necesarias usando las casillas a la izquierda y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Utilice estos botones para cambiar las páginas.</td></tr>
</table></p>';
$lngstr['tooltip_rtemplates'] = '<p>Esta página está destinada para crear/editar plantillas de informe.</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['page-rtemplates']['action_create_rtemplate'].'"></td><td class=rowone width="100%" colspan=4>Para crear una nueva plantilla, presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['page-rtemplates']['action_rtemplates_edit'].'"></td><td class=rowone width="100%" colspan=4>Para editar una plantilla, presione el botón a la derecha de la plantilla de informe.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['page-rtemplates']['action_rtemplate_delete'].'"></td><td class=rowone width="100%" colspan=4>Para eliminar plantilla(s) de informe, presione el botón a la derecha de la plantilla de informe o seleccione las plantillas de informe necesarias usando las casillas a la izquierda y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Utilice estos botones para cambiar las páginas.</td></tr>
</table></p>';
$lngstr['tooltip_tests_questions'] = '<p>Esta página está destinada para crear/editar preguntas.</p>
<p>Tabla de preguntas de examen:</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-add.gif" title="'.$lngstr['label_action_create_and_add_question'].'"></td><td class=rowone width="100%" colspan=4>Para crear una nueva pregunta y añadirla al examen, presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-import.gif" title="'.$lngstr['label_action_import_questions'].'"></td><td class=rowone width="100%" colspan=4>Para importar preguntas al examen, presione este botón.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_questions_edit'].'"></td><td class=rowone width="100%" colspan=4>Para editar una pregunta, presione el botón a la derecha de la pregunta.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=10 border=0 src="images/button-up.gif" title="'.$lngstr['label_action_question_moveup'].'"><br><img width=20 height=10 border=0 src="images/button-down.gif" title="'.$lngstr['label_action_grade_movedown'].'"></td><td class=rowone width="100%" colspan=4>Para mover la pregunta arriba o abajo, presione la parte superior o inferior del botón a la derecha.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_question_link_delete'].'"></td><td class=rowone width="100%" colspan=4>Para eliminar pregunta(s), presione el botón a la derecha de la pregunta o seleccione todas las preguntas necesarias usando las casillas a la izquierda y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Utilice estos botones para cambiar las páginas.</td></tr>
</table></p>
<p>Tabla del banco de preguntas:</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['label_action_create_question'].'"></td><td class=rowone width="100%" colspan=4>Para crear una nueva pregunta, presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-plus.gif" title="'.$lngstr['label_action_questions_append'].'"></td><td class=rowone width="100%" colspan=4>Para añadir una pregunta, presione el botón a la derecha o seleccione varias preguntas usando la casilla a la izquierda y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_question_edit'].'"></td><td class=rowone width="100%" colspan=4>Para editar una pregunta, presione el botón a la derecha de la pregunta.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_question_delete'].'"></td><td class=rowone width="100%" colspan=4>Para eliminar preguntas(s), seleccione la pregunta o preguntas y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Utilice estos botones cambiar las páginas.</td></tr>
</table></p>';
$lngstr['tooltip_tests_sections'] = '<p>Esta página está destinada para crear/editar secciones del examen.</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['page-sections']['action_section_create'].'"></td><td class=rowone width="100%" colspan=4>Para crear una nueva sección, presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['page-sections']['action_section_edit'].'"></td><td class=rowone width="100%" colspan=4>Para editar una sección, presione el botón a la derecha de la sección.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['page-sections']['action_section_delete'].'"></td><td class=rowone width="100%" colspan=4>Para eliminar secciones, presione el botón a la derecha o seleccione las secciones y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Utilice estos botones para cambiar las páginas.</td></tr>
</table></p>';
$lngstr['tooltip_tests_groups'] = '<p>Esta página está destinada para asignar preguntas a un examen.</p>
<p>Tabla de exámenes:</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['label_action_create_test'].'"></td><td class=rowone width="100%" colspan=4>Para crear un nuevo examen, presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-gear.gif" title="'.$lngstr['label_action_test_settings'].'"></td><td class=rowone width="100%" colspan=4>Para cambiar la configuración del examen presione este botón.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-groups.gif" title="'.$lngstr['label_action_test_groups_select'].'"></td><td class=rowone width="100%" colspan=4>Para asignar un examen a cierto grupo de usuarios, presione el botón a la derecha o seleccione los grupos y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_questions_edit'].'"></td><td class=rowone width="100%" colspan=4>Para editar preguntas, presione el botón a la derecha del examen.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_test_delete'].'"></td><td class=rowone width="100%" colspan=4>Para eliminar exámenes, presione el botón a la derecha o seleccione los exámenes y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Utilice estos botones para cambiar las páginas.</td></tr>
</table></p>
<p>Tabla de grupos:</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['label_action_create_group'].'"></td><td class=rowone width="100%" colspan=4>Para crear un nuevo grupo, presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_group_edit'].'"></td><td class=rowone width="100%" colspan=4>Para editar un grupo, presione el botón a la derecha del grupo.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_group_delete'].'"></td><td class=rowone width="100%" colspan=4>Para eliminar grupos, presione el botón a la derecha o seleccione múltiples grupos y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Utilice estos botones para cambiar las páginas.</td></tr>
</table></p>';
$lngstr['tooltip_questionbank'] = '<p>Esta página está destinada para crear/editar un banco de preguntas.</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['label_action_create_question'].'"></td><td class=rowone width="100%" colspan=4>Para crear una nueva pregunta, presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-stats.gif" title="'.$lngstr['label_action_questions_stats'].'"></td><td class=rowone width="100%" colspan=4>Para ver las estadísticas de una pregunta, presione el botón a la derecha o seleccione los elementos usando las casillas a la izquierda y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_question_edit'].'"></td><td class=rowone width="100%" colspan=4>Para editar una pregunta, presione el botón a la derecha de la pregunta.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_question_delete'].'"></td><td class=rowone width="100%" colspan=4>Para eliminar preguntas, presione el botón a la derecha o seleccione las preguntas necesarias usando las casillas a la izquierda y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Utilice estos botones para cambiar las páginas.</td></tr>
</table></p>';
$lngstr['tooltip_subjects'] = '<p>Esta página está destinada para crear/editar asignaturas.</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['label_action_create_subject'].'"></td><td class=rowone width="100%" colspan=4>Para crear una nueva asignatura, presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_subject_edit'].'"></td><td class=rowone width="100%" colspan=4>Para editar una asignatura, presione el botón a la derecha de la asignatura.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_subject_delete'].'"></td><td class=rowone width="100%" colspan=4>Para eliminar asignaturas, presione el botón a la derecha o seleccione las asignaturas necesarias usando las casillas a la izquierda y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Utilice estos botones para cambiar las páginas.</td></tr>
</table></p>';
$lngstr['tooltip_reportsmanager'] = '<p>Esta página está destinada para analizar los resultados de los exámenes.</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-view.gif" title="'.$lngstr['label_action_test_result_view'].'"></td><td class=rowone width="100%" colspan=4>Para ver los resultados detallados, presione el botón a la derecha de la entrada.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_test_result_delete'].'"></td><td class=rowone width="100%" colspan=4>Para eliminar entradas, presione el botón a la derecha o seleccione las entradas necesarias usando las casillas a la izquierda y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Utilice estos botones para cambiar las páginas.</td></tr>
</table></p>';
$lngstr['tooltip_reportsmanager_reportsratings'] = '';
$lngstr['tooltip_users'] = '<p>Esta página está destinada para crear/editar cuentas de usuario.</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['label_action_create_user'].'"></td><td class=rowone width="100%" colspan=4>Para crear un nuevo usuario, presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-groups.gif" title="'.$lngstr['label_action_manageusers_groups'].'"></td><td class=rowone width="100%" colspan=4>Para asignar al usuario a un grupo, presione el botón a la derecha o seleccione todos los usuarios necesarios usando las casillas a la izquierda y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_manageusers_edit'].'"></td><td class=rowone width="100%" colspan=4>Para editar un usuario, presione el botón a la derecha de la cuenta de usuario.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_manageusers_delete'].'"></td><td class=rowone width="100%" colspan=4>Para eliminar usuarios, presione el botón a la derecha o seleccione las cuentas de usuarios necesarias usando las casillas a la izquierda y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Utilice estos botones para cambiar las páginas.</td></tr>
</table></p>';
$lngstr['tooltip_users_groups'] = '';
$lngstr['tooltip_groups'] = '<p>Esta página está destinada para crear/editar grupos.</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-new.gif" title="'.$lngstr['label_action_create_group'].'"></td><td class=rowone width="100%" colspan=4>Para crear un nuevo grupo, presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-edit.gif" title="'.$lngstr['label_action_group_edit'].'"></td><td class=rowone width="100%" colspan=4>Para editar un grupo, presione el botón a la derecha del grupo.</td></tr>
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-cross.gif" title="'.$lngstr['label_action_group_delete'].'"></td><td class=rowone width="100%" colspan=4>Para eliminar grupos, presione el botón a la derecha o seleccione los grupos necesarios usando las casillas a la izquierda y presione este botón en la barra de herramientas.</td></tr>
<tr><td class=rowtwo width=20><img src="images/button-first.gif" border=0 title="'.$lngstr['button_first_page'].'"></td><td class=rowtwo width=20><img src="images/button-prev.gif" border=0 title="'.$lngstr['button_prev_page'].'"></td><td class=rowtwo width=20><img src="images/button-next.gif" border=0 title="'.$lngstr['button_next_page'].'"></td><td class=rowtwo width=20><img src="images/button-last.gif" border=0 title="'.$lngstr['button_last_page'].'"></td><td class=rowone width="100%">Utilice estos botones para cambiar las páginas.</td></tr>
</table></p>';
$lngstr['tooltip_visitors'] = '<p>Esta página está destinada para analizar las estadísticas web.</p>
<p><table class=rowtable2 cellpadding=5 cellspacing=1 border=0 width="100%">
<tr><td class=rowtwo width=20><img width=20 height=20 border=0 src="images/button-view.gif" title="'.$lngstr['label_action_visitors_view'].'"></td><td class=rowone width="100%" colspan=4>Para ver estadísticas detalladas, presione el botón a la derecha de la entrada.</td></tr>
...
$lngstr['label_country_items'] = array(
	...
	'LU' => 'Luxemburgo',
	'MO' => 'Macao',
	'MK' => 'Macedonia, Ex República de Yugoslavia',
	'MG' => 'Madagascar',
	'MW' => 'Malawi',
	'MY' => 'Malasia',
	'MV' => 'Maldivas',
	...
	'SD' => 'Sudán',
	'SR' => 'Surinam',
	'SJ' => 'Archipiélago de Svalbard e isla Jan Mayen',
	'SZ' => 'Swazilandia',
	'SE' => 'Suecia',
	'CH' => 'Suiza',
