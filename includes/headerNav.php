	...
	<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
		...
		<ul class="nav navbar-nav navbar-right">
          ...
          <li class="hoverAnchor">
            ...
            <a href="<?php echo site_root . "registration.php"; ?>" class="">Register</a>
          </li>
			<?php }
			} ?>
			<?php
		...
		<div class="navbar-default sidebar" role="navigation">
          ...
          <li>
						<a href="javascript:void(0);">
							<center>
								<img src="<?php $imageSrc = ($_SESSION['User_profile_pic']) ? $_SESSION['User_profile_pic'] : 'avatar.png';
													echo site_root . 'images/userProfile/' . $imageSrc; ?>" alt="Profile Image" class="showImagePopUp" width="65%" data-toggle="tooltip" title="Update your profile pic from My-Profile section">
							</center>
						</a>
					</li>
					<!-- end of user profile pic -->
					<li>
						<a style="color:#d1dae2;" href="selectgame.php" class="<?php echo ($_SESSION['userpage'] == 'selectgame') ? 'active' : ''; ?>"><i style="padding-right:20px;" class="glyphicon glyphicon-bishop"></i> Cards</a>
					</li>
					<li class="hidden">
					...
					<!-- <li>
						<a style="color:#d1dae2;" href="howToPlay.php" class="<?php echo ($_SESSION['userpage'] == 'howToPlay') ? 'active' : ''; ?>"><i style="padding-right:20px;" class="glyphicon glyphicon-play"></i> Guide</a>
					</li> -->
					<li>
...
<body background="images/bg3.jpg">
	...
	<div id="loader" class="col-md-12 overlay">
		...
		<div class="dbl-spinner"></div>
		<!-- <div class="overlay-content"><span>Please Wait...</span></div> -->
