		...
		<div class="container-fluid" >
			...
			<div class="collapse sidebar navbar-collapse" id="myNavbar" style="" >
				<div class="vertical-menu" style="margin-top:25px; margin-left:-20px;">
					...
					<a style="width:295px;" href="gameCatalogue.php" class="<?php echo ($_SESSION['userpage'] == 'gameCatalogue')?'active':'';?>"><i style="padding-right:20px;" class="glyphicon glyphicon-knight"></i> Catalogue</a>
