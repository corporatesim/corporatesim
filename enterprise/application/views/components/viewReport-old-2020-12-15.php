<?php 
  $reportData = explode('/', trim(uri_string())); 
  $formData   = (isset($reportData[2])) ? $reportData[2] : NULL;
  // echo $formData;
?>
<!--   <link href="http://ttc.microwarecomp.com/common/backend/css/app.min.1.css" rel="stylesheet">
                ...
                <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                 <!--  <div class="clearfix mb-20">
                  ...
                  <div class="col-12 col-md-2 pull-right">
                   <!--  <input id="downloadReportTable" value="Download Report" class="btn btn-primary downloadReportTable" readonly> -->
  ...
  <script>
    $(document).ready(function(){
      ...
      $('.downloadReportTable').on('click', function() {
        // console.log('<?php echo $formData; ?>');
        var formData = "<?php echo $formData; ?>";
        // triggerAjax("<?php echo base_url('AjaxNew/downloadReportTwoTableData/'); ?>"+formData);
        $.ajax({
          url: "<?php echo base_url('AjaxNew/getReportTwoDataTable/'); ?>"+formData,
          type: 'POST',
        });
      });
