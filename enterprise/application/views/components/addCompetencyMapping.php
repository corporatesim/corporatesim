						...
						<div class="title">
							<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
								<div class="clearfix mb-20">
									<h5 class="text-blue">Add Competency Mapping</h5>
								</div>
									...
									<div class="col-sm-12 col-md-9">
										<select name="Cmap_ComptId" id="Cmap_ComptId" class="custom-select2 form-control" required="">
											...
											<?php foreach ($competency as $competencyRow) { ?>
												<option value="<?php echo $competencyRow->Compt_Id;?>" title="<?php echo $competencyRow->Compt_Description; ?>"><?php echo $competencyRow->Compt_Name; ?></option>
											<?php } ?>
									...
									<div class="col-sm-12 col-md-9">
										<select name="Cmap_GameId[]" id="Cmap_GameId" class="custom-select2 form-control" multiple="" required="">
											<?php foreach ($games as $gamesRow) { ?>
												<option value="<?php echo $gamesRow->Game_ID;?>" title="<?php echo $gamesRow->Game_Comments; ?>"><?php echo $gamesRow->Game_Name; ?></option>
											<?php } ?>
