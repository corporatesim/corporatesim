	...
	<section class="body-sign">
		<div class="center-sign">
			...
			<a href="<?php echo base_url();?>" class="logo pull-left">
				<img src="<?php echo base_url('common/loginSignup');?>/images/logo-main.png" height="54" alt="Porto Admin" />
			</a>
			...
			<div class="panel panel-sign">
				...
				<div class="panel-body">
					...
					<form method="post" action="">
						...
						<p class="text-center mt-lg">Remembered? <a href="<?php echo base_url();?>">Sign In!</a>
						</form>
					</div>
				</div>
