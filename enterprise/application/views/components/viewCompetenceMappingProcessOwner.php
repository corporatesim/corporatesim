...
<div class="main-container">
            ...
            <div class="title">
              <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                <div class="clearfix mb-20">
                  <h5 class="text-blue">Mapping</h5>
                </div>

                <?php echo form_open('', 'id="competenceMappingForm"', ''); ?>

                <div class="row col-md-12 col-lg-12 col-sm-12 row form-group d-none">
                  <label for="Cmap_Enterprise_ID" class="col-sm-12 col-md-3 col-form-label">Enterprize </label>
                ...
                <div class="row col-md-12 col-lg-12 col-sm-12 row form-group">
                  <label for="Cmap_Performance_Type" class="col-sm-12 col-md-3 col-form-label">Factor Type </label>
                  <div class="col-sm-12 col-md-9">
                ...
                <div class="row col-md-12 col-lg-12 col-sm-12 row form-group">
                  <label for="Cmap_ComptId" class="col-sm-12 col-md-3 col-form-label">Sub-factor</label>
                  <div class="col-sm-12 col-md-9">
                ...
                <div class="row col-md-12 col-lg-12 col-sm-12 row form-group">
                 <label for="Cmap_GameId" class="col-sm-12 col-md-3 col-form-label">Card(s) </label>
                 <div class="col-sm-12 col-md-9">
  ...
  <script>
    $(document).ready(function(){
      ...
      $("#Cmap_GameId").attr('disabled','disabled');
    }); 
  </script>