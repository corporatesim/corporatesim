				...
				<div class="row">
					<div class="col-md-12 col-sm-12">
                        ...
                        <?php } ?>
                          ...
                          <?php if ($this->session->userdata('loginData')['User_Role'] == 'superadmin') { ?>
  													<td><?php echo $enterpriseusersDetails->Enterprise_Name ; ?></td>
                          <?php } ?>
													<td><?php echo $enterpriseusersDetails->User_username;?></td>
                          ...
                          <!-- Cards -->
                          <?php if ($this->session->userdata('loginData')['User_Role'] == 'superadmin') { ?>
													 <a href="<?php echo base_url('Games/assignGames/'); ?><?php echo base64_encode($enterpriseusersDetails->User_id).'/'.base64_encode($this->uri->segment(2)); ?>" data-toggle="tooltip" title="Allocate/Deallocate Cards"><?php echo "<b style='color:#0029ff;'>".$enterpriseusersDetails->gameCount."</b>"; ?></a>
                          <?php } else { 
                             echo "<b style='color:#0029ff;'>".$enterpriseusersDetails->gameCount."</b>"; 
                          } ?>

												<!-- &nbsp; <a href="javascript:void(0);" onclick="downloadCompletedGamesReport('<?php echo base64_encode($enterpriseusersDetails->User_id); ?>');" data-toggle="tooltip" title="Download CSV For All Complted Cards"><i class="fa fa-download"></i></a> -->
											</td>
											...
											<td>
												<div class="dropdown">
													...
													<div class="dropdown-menu dropdown-menu-left">
														...
														<!-- <a class="dropdown-item" href="<?php //echo base_url('Enterprise/assignGames/');?><?php //echo base64_encode($enterpriseusersDetails->User_id); ?>" title="Allocate/Deallocate Cards"><i class="fa fa-gamepad"></i> Allocate/Deallocate Cards</a> -->
