						...
						<form method="post" action="">
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label">
									<span class="alert-danger">*</span> Enterprise
								</label>
							...
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label"><span class="alert-danger">*</span> First Name</label>
								<div class="col-sm-12 col-md-6">
									<input class="form-control" type="text" name="User_fname" placeholder="FirstName" value="<?php echo $editUser->User_fname ?>">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label"><span class="alert-danger">*</span> Last Name</label>
								<div class="col-sm-12 col-md-6">
							...
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label"><span class="alert-danger">*</span> User Name</label>
								<div class="col-sm-12 col-md-6">
									<input class="form-control" name="User_username" value="<?php echo $editUser->User_username ?>">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label"><span class="alert-danger">*</span> Email</label>
								<div class="col-sm-12 col-md-6">
									<input class="form-control" name="User_email" value="<?php echo $editUser->User_email ?>">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-12 col-md-2 col-form-label"><span class="alert-danger">*</span> Mobile No.</label>
								<div class="col-sm-12 col-md-6">
							...
							<?php if($editUser->User_SubParentId != -2){?>
								<div class='form-group row'>
									<label for='SubEnterprise' class='col-sm-12 col-md-2 col-form-label'><span class="alert-danger">*</span> SubEnterprise</label>
									<div class='col-sm-12 col-md-6'>
