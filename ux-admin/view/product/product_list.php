...
<!--
	var loc_url_del = "ux-admin/ManageProducts/delete=";
	var loc_url_stat = "ux-admin/ManageProducts/stat=";
//-->
</script>
	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="col-xs-6 col-sm-6">Product List</div>
				<div class="col-sm-6 text-right">
					<button type="button" class="btn btn-primary"
						onclick="window.location='<?php echo site_root."ux-admin/ManageProducts/add/true"; ?>'"
					>Add Product</button>
				</div>
			...
			<div class="panel-body">
				<div class="dataTable_wrapper table-responsive">
					<table class="table table-striped table-bordered table-hover"
						...
						<tbody>
						<?php if($productsList->num_rows > 0){ ?>
							<?php $i=1; while($rows = $productsList->fetch_object()){ ?>
								<tr>
									<td><?php echo $i; ?></td>
									...
									<td class="text-center">
										...
										<a href="<?php echo site_root; ?>ux-admin/ManageProducts/edit/<?php echo $functionsObj->numhash($rows->p_id);?>">
