...
<!--
	var loc_url_del  = "ux-admin/competencyFormula/del/";
	var loc_url_stat = "ux-admin/competencyFormula/stat/";
//-->
</script>

<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Competency Formulas</h1>
	</div>
</div>
...
<div class="row">
	<div class="col-sm-12">
		<ul class="breadcrumb">
			...
			<li class="active">Competency Formulas</li>
		</ul>
	</div>
</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<div class="pull-right">
					<input class="btn btn-primary" type="button" name="add_formula" value="Add Formula"
						onclick="window.location.href='<?php echo site_root."ux-admin/competencyFormula/add/1"; ?>';"/>
				</div>
				<?php } ?>
				<div class="clearfix"></div>
			</div>
							...
							<?php 
								...
								<tr>
									...
									<td class="text-center">
										...
										<a href="<?php echo site_root."ux-admin/competencyFormula/edit/".base64_encode($row->f_id); ?>"
