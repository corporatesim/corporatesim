<script type="text/javascript">
	<!--
		var loc_url_del  = "ux-admin/manageCompetency/del/";
		var loc_url_stat = "ux-admin/manageCompetency/stat/";
  //-->
</script>
<style>
	<!--
		...
		<div class="panel panel-default" id="loader">
			<div class="panel-heading">
				...
				<div class="pull-right">
					<a class="btn btn-primary" href="<?php echo site_root."ux-admin/manageCompetency/add/1"; ?>">Add Compentency</a>
				</div>
				<div class="pull-right">
					<!-- Modal -->
							...
							$i=1; while($row = $object->fetch_object()){ ?>
								<tr>
									...
									<td class="text-center">
										<a data-toggle="tooltip" href="<?php echo site_root."ux-admin/manageCompetency/edit/".base64_encode($row->Compt_Id); ?>"
