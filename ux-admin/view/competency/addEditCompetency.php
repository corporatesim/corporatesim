...
<div class="row">
	<div class="col-sm-12">
		<ul class="breadcrumb">
			...
			<li class="active"><a href="<?php echo site_root.'ux-admin/manageCompetency';?>">Manage Compentency</a></li>
...
<div class="col-sm-10">
	<form method="POST" action="" id="siteuser_frm" name="siteuser_frm">
		...
		<div class="form-group">
			<label for="name" class="containerCheckbox"><span class="alert-danger">*</span>Competency Name</label>
			<input type="text" name="Compt_Name" class="form-control" value="<?php if(isset($_GET['edit'])){ echo $gameObj->Compt_Name; } ?>" placeholder="Enter Competency Name" required>
		</div>
