			...
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge" id="num_users">10</div>
						<div>Some Text!</div>
					</div>
				</div>
			</div>
			<a href="#" class="col-sm-12 col-xs-12">View Details<i class="pull-right fa fa-arrow-circle-right"></i></a>
			<div class="clearfix"></div>
		</div>
	</div>
	<div class="col-sm-3">
		<div class="panel panel-green panel_green">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge" id="deals">6</div>
						<div>Some Text!</div>
					</div>
				</div>
			</div>
			<a href="#" class="col-sm-12 col-xs-12">View Details<i class="fa fa-arrow-circle-right"></i></a>
			<div class="clearfix"></div>
		</div>
	</div>
	<div class="col-sm-3">
		<div class="panel panel-yellow panel_yellow">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge" id="business">5</div>
						<div>Some Text!</div>
					</div>
				</div>
			</div>
		...
		<div class="panel panel-red panel_red">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge" id="payments">1</div>
						<div>Some Text!</div>
					</div>
				</div>
			</div>
