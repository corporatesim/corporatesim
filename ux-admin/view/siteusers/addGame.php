				...
				<div class="col-sm-12">
					<div class="form-group text-center">
						<?php if(isset($_GET['edit']) && !empty($_GET['edit'])){?>
							<button type="button" id="siteuser_btn_update" data-checkdate="checkDate" class="btn btn-primary"> Update </button>
						...
						<?php }else{?>
							<button type="button" id="siteuser_btn" data-checkdate="checkDate" class="btn btn-primary" value="Submit"> Submit </button>
