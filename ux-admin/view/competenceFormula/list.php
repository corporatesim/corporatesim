<script type="text/javascript">
	<!--
		var loc_url_del  = "ux-admin/competenceFormula/del/";
		var loc_url_stat = "ux-admin/competenceFormula/stat/";
//-->
</script>
	...
	<div class="col-lg-12">
		<h1 class="page-header">
			<?php if($functionsObj->checkModuleAuth('formulas','add')){ ?>
				<a href="<?php echo site_root."ux-admin/competenceFormula/add/1"; ?>" data-toggle="tooltip" title="Add Competence Formula">
		...
		<ul class="breadcrumb">
			<li class="completed"><a
				...
				<li class="completed">
					...
					<li class="active">Competence Formulas</li>
				</ul>
			</div>
		</div>
										...
										<tr>
											...
											<td class="text-center">
												<?php if($functionsObj->checkModuleAuth('formulas','edit')){ ?>
													<a href="<?php echo site_root."ux-admin/competenceFormula/edit/".base64_encode($row->f_id); ?>"
