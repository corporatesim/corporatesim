									...
									<form method="post" action="" enctype="multipart/form-data">
										...
										<div class="form-group col-sm-12">		
											<label>
												...
												?>
												<input type="radio" value="0" <?php echo $checkUrl;?> name="ScenVdo_Type"> URL
												<input type="radio" value="1" <?php echo $checkEmbed;?> name="ScenVdo_Type"> Embed
											</label>
											<input name="vdourl" id="vdourl" class="form-control" value='<?php if(isset($_GET["tab"])){ if($resultdoc->ScenVdo_Type > 0){
												echo base64_decode($resultdoc->ScenVdo_Name);
												} else{
												echo $resultdoc->ScenVdo_Name;
											} } ?>'>
										</div>
										<div class="form-group col-sm-12">		
												...
												if($object->num_rows > 0){	
													...
													while($row = $object->fetch_object()){ ?>
														<tr>										
															...
															<td>
																<?php echo ($row->ScenVdo_Type == 1)?base64_decode($row->ScenVdo_Name):$row->ScenVdo_Name;?>
															</td>
