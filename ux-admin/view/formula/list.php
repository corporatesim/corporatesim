		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="dataTable_wrapper">
					<table class="table table-striped table-bordered table-hover text-center" id="dataTables-serverSide" data-url="<?php echo site_root . 'ux-admin/model/ajax/dataTables.php'; ?>" data-action="listFormula">
						<thead>
							<tr>
								<th>#</th>
								<th>Formula</th>
								<th>Formula Expression</th>
								<th>Formula Linkage</th>
								<th>Created ON</th>
								<th>Updated ON</th>
