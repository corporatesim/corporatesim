				...
				<div class="col-md-4">
					...
					<select class="form-control" name="game_id" id="game_id">
						...
						<?php while($row = $game->fetch_object()){ 
							...
							{
								case '0,0':
								$title      = "Normal-Game, In-Progress";
								$editStatus = '';
								break;

								case '0,1':
								$title      = "Normal-Game, Completed, So can not make changes";
								$editStatus = 'disabled';
								break;

								case '1,0':
								$title      = "Bot-Enabled, In-Progress";
								$editStatus = '';
								break;

								case '1,1':
								$title      = "Bot-Enabled, Completed, So can not make changes";
								$editStatus = 'disabled';
								break;
							}
							?>
