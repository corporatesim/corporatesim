...
<script>
	...
	function fetchScenarioErrorLog(linkIdForError)
  {
		var form_data = "action=fetchScenarioErrorLog&Gal_LinkId="+linkIdForError;
		var fetchErrorLog = triggerAjax("<?php echo site_root . 'ux-admin/model/ajax/findErrorLog.php'; ?>", form_data, 'show');
    // console.log(fetchErrorLog);
		setTimeout(() => {
