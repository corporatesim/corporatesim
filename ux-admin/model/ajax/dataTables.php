...
if ($_POST['action'] == 'getlinkage') {
    ...
    // error log
    $action .= ' <a href="javascript:void(0);" title="Show Error Log" onclick="return fetchScenarioErrorLog('.$fetchLinkageRow->Link_ID.')"> <i class="fa fa-exclamation-triangle"></i> </a>';
