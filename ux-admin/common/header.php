...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
	...
	<ul class="nav navbar-top-links navbar-right text-right">
		<!-- <li>
			<a href="<?php echo site_root."login.php"; ?>" target="_blank">View Website</a>
		</li> -->
		...
		<li class="nav-item dropdown no-arrow mx-1">
			<a href="javascript:void(0);">Hi, <?php echo $_SESSION['admin_fname'].' '.$_SESSION['admin_lname'];?></a>
		</li>
		<?php
		...
		<li class="dropdown">
			<a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);"> <i class="fa fa-user fa-fw"></i>
				<i class="fa fa-caret-down"></i>
			</a>
			<ul class="dropdown-menu dropdown-user">
				<li>
					<a href="<?php echo site_root."ux-admin/MyProfile";?>"><i class="fa fa-user fa-fw"></i> My Profile</a>
				</li>
				<?php if($_SESSION['ux-admin-id'] == 1){ ?>
					<li>
						<a href="<?php echo site_root."ux-admin/SiteSettings"?>">
							<i class="fa fa-gear fa-fw"></i> Site Settings
						</a>
		<!--<li>
		<a href="<?php //echo site_root."ux-admin/SeoSettings"?>">
		<i class="fa fa-gear fa-fw"></i> SEO Settings</a>
		</li>
		<li class="divider"></li> -->
	<?php } ?>
	<li>
		<a href="<?php echo site_root."ux-admin/Logout"?>">
...
<div class="navbar-default sidebar" role="navigation">
	<div class="sidebar-nav navbar-collapse">
		<ul class="nav" id="side-menu">
			<li>
				<a href="<?php echo site_root."ux-admin/Dashboard";?>">
				...
				<?php if($_SESSION['admin_usertype']=='superadmin') {?>
					...
					<li id="manageCMS" class="hidden"><a href="javascript:void(0);"><i class="fa fa-institution"></i> Enterprise/SubEnterprise
						<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<?php if($functionsObj->checkModuleAuth('ManageEnterprise','enable')){ ?>
								<li>
									<a href="<?php echo site_root."ux-admin/ManageEnterprise";?>">
									Manage Enterprise</a>
								</li>
							<?php } if($functionsObj->checkModuleAuth('ManageSubEnterprise','enable')){ ?>
								<li>
									<a href="<?php echo site_root."ux-admin/ManageSubEnterprise";?>">
									Manage SubEnterprise</a>
								</li>
							<?php } if($functionsObj->checkModuleAuth('EntSubEnterpriseUsers','enable')){ ?>
								<li>
									<a href="<?php echo site_root."ux-admin/EntSubEnterpriseUsers";?>">
									Enterprise/SubEntprise Users</a>
								</li>
							<?php } ?>					
						</ul>
					</li>
					<!-- User Management -->
					<li id="manageUser"><a href="javascript:void(0);"><i class="fa fa-users fa-fw"></i> User Management
						<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<?php if($functionsObj->checkModuleAuth('SiteUsers','enable')){ ?>
								<li>
									<a href="<?php echo site_root."ux-admin/siteusers";?>">
									Site Users</a>
								</li>
							<?php } if($functionsObj->checkModuleAuth('UserReport','enable')){ ?>
								<li>
									<a href="<?php echo site_root."ux-admin/UserReport";?>">
									User Report</a>
								</li>
							<?php } if($functionsObj->checkModuleAuth('ReplayPermission','enable')){ ?>
								<li>
									<a href="<?php echo site_root."ux-admin/ReplayPermission";?>">
									Replay Permission</a>
								</li>
							<?php } ?>
						</ul>
					...
					<!-- Master Management -->
					<li id="manageCMS"><a href="javascript:void(0);"><i class="fa fa-wrench fa-fw"></i> Master Management<span class="fa arrow">
					</span></a>
					<ul class="nav nav-second-level">
						<?php if($functionsObj->checkModuleAuth('area','enable')){ ?>
							<li>
								<a href="<?php echo site_root."ux-admin/ManageArea";?>">
								Area</a>
							</li>
						<?php } if($functionsObj->checkModuleAuth('component','enable')){ ?>
							<li>
								<a href="<?php echo site_root."ux-admin/ManageComponent";?>">
								Component</a>
							</li>
						<?php } if($functionsObj->checkModuleAuth('sub component','enable')){ ?>
							<li>
								<a href="<?php echo site_root."ux-admin/ManageSubComponent";?>">
								Sub Component</a>
							</li>
				...
				<!-- Link Managemet -->
				<li id="manageCMS">
					<a href="javascript:void(0);"><i class="fa fa-link fa-fw"></i> Link Management<span class="fa arrow">
					</span>
				</a>
				<ul class="nav nav-second-level">
					...
					<?php } if($functionsObj->checkModuleAuth('linkage','enable')){ ?>
						<li>
							<a href="<?php echo site_root."ux-admin/linkage";?>">
							Linkage</a>
						</li>
					<?php } if($functionsObj->checkModuleAuth('chartComp','enable')){ ?>
						<li>
							<a href="<?php echo site_root."ux-admin/chartComp";?>">
							Chart Component</a>
						</li>
					<?php  } if($functionsObj->checkModuleAuth('chart','enable')){ ?>
						<li>
							<a href="<?php echo site_root."ux-admin/chart";?>">
							Chart Subcomponent</a>
						</li>
					<?php } ?>					
				</ul>
			</li>
			...
			<!--  Outcome management -->
			<li id="manageCMS">
				<a href="javascript:void(0);"><i class="fa fa-tasks fa-fw"></i> Outcome Management <span class="fa arrow"></span>
				</a>
				<ul class="nav nav-second-level">
					<?php if($functionsObj->checkModuleAuth('ScenarioBranching','enable')){ ?>
						<li>
							<a href="<?php echo site_root."ux-admin/ScenarioBranching";?>">
							Scenario Branching</a>
						</li>
					<?php } if($functionsObj->checkModuleAuth('outcomeBadges','enable')){ ?>
						<li>
							<a href="<?php echo site_root."ux-admin/outcomeBadges";?>">
							Outcome Badges</a>
						</li>					
					<?php } if($functionsObj->checkModuleAuth('personalizeOutcome','enable')){ ?>
						<li>
							<a href="<?php echo site_root."ux-admin/personalizeOutcome";?>">
							Personalized Outcome</a>
						</li>									
			...
			<!-- Mis Report -->
			<li id="manageCMSmis"><a href="javascript:void(0);"><i class="fa fa-file"></i> MIS Report <span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
