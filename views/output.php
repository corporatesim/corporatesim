              ...
              //Get Component for this area for this linkid
                ...
                //{
                  ...
                  //echo $row1['Comp_Name'];
                      ...
                      $sqlOutcome      = "SELECT * FROM GAME_PERSONALIZE_OUTCOME gpo WHERE gpo.Outcome_CompId=".$row1['CompID']." AND gpo.Outcome_LinkId=".$linkid." AND ".$row1['CURRENT'].">=gpo.Outcome_MinVal AND ".$row1['CURRENT']."<=gpo.Outcome_MaxVal AND gpo.Outcome_IsActive=0 ORDER BY Outcome_Order";
                      ...
                      if($objRes->num_rows > 0)
                      {
                      	while($objectResult = $functionsObj->FetchObject($objRes))
                      	{
                      		...
                      		if($objectResult->Outcome_FileType !=3 && ($row1['CURRENT']>=$objectResult->Outcome_MinVal AND $row1['CURRENT']<=$objectResult->Outcome_MaxVal))
                      		{
