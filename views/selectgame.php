...
<div class="col-sm-10">
	...
	if($disable == 'disabled' || $result->num_rows < 1)	{ ?>
		<marquee behavior="alternate" direction="" onMouseOver="this.stop()" onMouseOut="this.start()" class="row">
			<div class="col-md-6 col-sm-12" style="color:#a94442; background-color:#f2dede; border-color:#ebccd1; text-align:center; width:50%; font-weight:bold;"><?php echo $game_status; ?></div>
		</marquee>
	<?php	die(); }	?>
