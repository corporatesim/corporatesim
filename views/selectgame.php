			...
			{		
				...
				{						
					...
					else
					{
						...
						{
							$urlstr .= " <a id='restart' title='Replay will loose all your progress' href='#' data-GameID='".$row['Game_ID']."' data-ScenID='".$ScenID."' data-LinkID='".$linkid."'><img src='images/restartGameIcon.png' alt='ReStart/Resume Game' class=''></a>";
						}
					}
				}
				else
