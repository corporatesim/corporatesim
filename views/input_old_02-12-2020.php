...
<?php if (!empty($result)) { ?>
  ...
  <div id="rightSidenav" class="row">
    ...
    <a class="rotateCompAnti" href="javascript:void(0);" style="padding-left: 120px; margin-top: 410px;">
      <button class="btn btn-danger" id="submitBtn" type="button"><?php echo $result->Link_ButtonText; ?></button>
    </a>
        ...
        <?php if ($result->BackgroundImage) { ?>
          ...
          <?php } else { ?>
            ...
            <div class=" TabMain col-sm-12">
              ...
              <div class="row">
                <div class="progress" style="margin-bottom:0; height:13px; background-color:#00000000;" id="progressbarData">
  ...
  $(document).ready(function() {
    ...
    $('#submitBtn').on('click', function() {
      ...
      swalWithBootstrapButtons.fire({
        ...
        html: 'Have you gone through all screens using <button type="button" class="btn btn-primary"><</button>&nbsp;<button type="button" class="btn btn-primary">></button> and ready for next section? <br> You will not be able to come back if you leave.',
        icon: 'warning',
