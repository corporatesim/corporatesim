        ...
        <!--<div class="col-sm-9 col-md-10 no_padding"><h2 class="InnerPageHeader"><?php if(!empty($result)){ echo $result->Game." | ".$result->Scenario ; }?> Your Output</h2></div>
          ...
          <div class="col-md-12 InnerPageHeader">
            ...
            <?php if(!$skipOutput->Link_Enabled > 0){ ?>
              <button type="button" name="submit" id="submitShowRight" class="btn btn-danger rotateCompAnti submitShowRight" value="Submit" style="margin-top: 410px;"><?php echo $result->Link_ButtonTextOutput; ?></button>
            <?php } ?>
          </div>
          ...
          -->
            ...
            <div class=" TabMain col-sm-12">
                ...
                <div class="progress" style="margin-bottom:0; height:13px; background-color:#d8d8d8;" id="progressbarData">
