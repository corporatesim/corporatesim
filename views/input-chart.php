	...
	<div class="container">
		...
		<div class="container">
			<div class="row">
				...
				<div class="dd_pushupbox" id="mypopupID1" style="width: 800px; height: 400px;">
      ...
      function drawVisualization() {
       ...
       //     [role:  domain,   data,       data,      data,   domain,   data,     data],    --  hint for cols
			...
			<?php //while($row_chart = mysqli_fetch_array($chartdata)) { ?>
			
					['60 DAYS MANHOUR REQUIREMENTS', 60000],
					['90 DAYS MANHOUR REQUIREMENTS', 80000],
        ...
        var options = {
          ...
          vAxis: {title: " --- Inputs  ----- -> ",titleTextStyle:{ fontName: 'Chango'}},
          hAxis: {title: "---------------------- Components ---------------- -> ",titleTextStyle:{ fontName: 'Chango'},textStyle: {color: '#000', fontSize: 12},textPosition:"out",slantedText:false},
          seriesType: "bars",
        };
				...
				<form method="POST" action="" id="game_frm" name="game_frm">
					<div class="col-sm-12 no_padding shadow">
						<div class="col-sm-6 ">
							...
							<a onclick="DD_PushUpID('mypopupID1','Chart');" class="innerPageLink">Dashboard</a><i class="fa fa-window-restore" aria-hidden="true"></i>
						...
						while($row = mysqli_fetch_array($area)) {
							...
							while($row1 = mysqli_fetch_array($component)){		
									...
									if ($row1['Mode']!="none")
									{
										echo "<div class=' col-sm-5 col-md-3 text-right'>";
											echo "<div class='InlineBox'>";
												...
												echo "<input type='hidden' id='".$areaname."_linkcomp_".$row1['CompID']."' name='".$areaname."_linkcomp_".$row1['CompID']."' value='".$row1['SubLinkID']."'>";
									...
									$sqlsubcomp = "SELECT distinct a.Area_ID as AreaID, ls.SubLink_CompID as CompID, ls.SubLink_SubCompID as SubCompID,  
											...
											ls.SubLink_Details as Description, ls.SubLink_InputMode as Mode , f.expression as exp, 
										...
										if ($row2['Mode']!="none")
										{
											echo "<div class=' col-sm-5 col-md-3 text-right'>";
												echo "<div class='InlineBox'>";
													...
													echo "<input type='hidden' id='".$areaname."_linksubc_".$row2['SubCompID']."' name='".$areaname."_linksubc_".$row2['SubCompID']."' value='".$row2['SubLinkID']."'>";
